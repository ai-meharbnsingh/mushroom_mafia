...
async def seed_climate_guidelines(db: AsyncSession):
    ...
    guidelines_data = [
        # ── OYSTER ──────────────────────────────────────────────────────
        (PlantType.OYSTER, GrowthStage.INOCULATION,
         20, 24, 60, 70, None, None, 2, 3,
         "Keep sterile, minimal air exchange"),
        (PlantType.OYSTER, GrowthStage.SPAWN_RUN,
         24, 28, 80, 85, None, 5000, 14, 21,
         "Darkness preferred, CO2 tolerance high"),
        (PlantType.OYSTER, GrowthStage.INCUBATION,
         20, 24, 85, 90, None, 2000, 7, 14,
         "Gradual fresh air introduction"),
        (PlantType.OYSTER, GrowthStage.FRUITING,
         13, 18, 85, 95, 400, 1000, 5, 10,
         "CO2 critical! Max ventilation needed"),
        (PlantType.OYSTER, GrowthStage.HARVEST,
         15, 20, 70, 80, None, None, 1, 3,
         "Reduce humidity to firm up caps"),
        (PlantType.OYSTER, GrowthStage.IDLE,
         None, None, None, None, None, None, None, None,
         "Room resting, clean and sanitize"),

        # ── BUTTON ──────────────────────────────────────────────────────
        (PlantType.BUTTON, GrowthStage.INOCULATION,
         22, 25, 65, 75, None, None, 1, 2,
         "Sterile substrate preparation"),
        (PlantType.BUTTON, GrowthStage.SPAWN_RUN,
         24, 27, 85, 90, None, 8000, 14, 21,
         "Keep covered, no light needed"),
        (PlantType.BUTTON, GrowthStage.INCUBATION,
         20, 22, 90, 95, None, 3000, 10, 14,
         "Casing layer applied, gentle misting"),
        (PlantType.BUTTON, GrowthStage.FRUITING,
         16, 18, 85, 90, 800, 1500, 7, 14,
         "Good air flow, indirect light"),
        (PlantType.BUTTON, GrowthStage.HARVEST,
         15, 18, 70, 80, None, None, 2, 4,
         "Harvest when caps still closed"),
        (PlantType.BUTTON, GrowthStage.IDLE,
         None, None, None, None, None, None, None, None,
         "Room resting"),

        # ── SHIITAKE ────────────────────────────────────────────────────
        (PlantType.SHIITAKE, GrowthStage.INOCULATION,
         20, 25, 60, 70, None, None, 1, 2,
         "Log or bag inoculation"),
        (PlantType.SHIITAKE, GrowthStage.SPAWN_RUN,
         20, 25, 70, 80, None, 5000, 30, 60,
         "Long colonization period"),
        (PlantType.SHIITAKE, GrowthStage.INCUBATION,
         18, 22, 80, 85, None, 2000, 14, 21,
         "Cold shock may help initiation"),
        (PlantType.SHIITAKE, GrowthStage.FRUITING,
         10, 16, 80, 90, 500, 1000, 7, 14,
         "Cool temps trigger fruiting"),
        (PlantType.SHIITAKE, GrowthStage.HARVEST,
         12, 18, 70, 80, None, None, 2, 3,
         "Harvest before caps flatten"),
        (PlantType.SHIITAKE, GrowthStage.IDLE,
         None, None, None, None, None, None, None, None,
         "Room resting"),

        # ── MIXED ──────────────────────────────────────────────────────
        (PlantType.MIXED, GrowthStage.INOCULATION,
         20, 24, 60, 70, None, None, 2, 3,
         "General guidelines"),
        (PlantType.MIXED, GrowthStage.SPAWN_RUN,
         22, 26, 80, 85, None, 5000, 14, 21,
         "Moderate ranges"),
        (PlantType.MIXED, GrowthStage.INCUBATION,
         20, 24, 85, 90, None, 2000, 7, 14,
         "Balanced approach"),
        (PlantType.MIXED, GrowthStage.FRUITING,
         14, 18, 85, 95, 500, 1200, 5, 10,
         "Moderate ventilation"),
        (PlantType.MIXED, GrowthStage.HARVEST,
         15, 20, 70, 80, None, None, 1, 3,
         "General harvest conditions"),
        (PlantType.MIXED, GrowthStage.IDLE,
         None, None, None, None, None, None, None, None,
         "Room resting"),
    ]

    count = 0
    for (plant_type, stage, t_min, t_max, h_min, h_max,
         c_min, c_max, d_min, d_max, notes) in guidelines_data:
